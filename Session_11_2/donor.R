##############################################################################
####### this is file "donor.R"
####### This version: 2014-02-04
####### I run the analyses for the synthetic control study of donor countries
##############################################################################
...
#### Create dotchart of country weights
dotchart(a[,1],pch=16)
